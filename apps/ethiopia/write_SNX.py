...
# def writeSNX_main_hist(DSSAT_PATH,station,start_year,end_year,planting_date,cultivar,soil_type,initial_soil_moisture,initial_soil_no3_content,planting_density,scenario):
def writeSNX_main_hist(DSSAT_PATH,station,planting_date,crop,cultivar,soil_type,initial_soil_moisture,initial_soil_no3_content,
...
# ======================================================================================
# ======================================================================================
def writeSNX_main_frst(DSSAT_PATH,station,planting_date,crop,cultivar,soil_type,initial_soil_moisture,initial_soil_no3_content,
                       planting_density,scenario,fert_app, df_fert):    
...
#-------------------------------------------
    ...
    # write *SIMULATION CONTROLS
    temp_str = fr.readline()
    new_str = temp_str[0:17] + NYERS.rjust(3) + temp_str[20:33] + SDATE + temp_str[38:]  #EJ(7/27/2021) generated weather are stored in ONE long WTH file for the next 100 yr simulations
    fw.write(new_str)
    temp_str = fr.readline()  # @N OPTIONS
    fw.write(temp_str)
    temp_str = fr.readline()  # 1 OP

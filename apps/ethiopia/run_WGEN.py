...
# from WGEN_generator import WGEN_generator   #EJ(7/27/2021)
...
from apps.ethiopia.WGEN_PAR_biweekly import WGEN_PAR_biweekly  
from apps.ethiopia.low_freq_correction import low_freq_correction  
from apps.ethiopia.season_bias_corr import season_bias_corr  #EJ(7/12/2021) bias correction for seasonal total rainfall

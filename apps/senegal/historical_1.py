                    ...
                    dbc.Col([
                      ...
                      html.Div([ # FERTILIZER INPUT TABLE
                        ...
                        dbc.Row([
                            ...
                            dbc.Col(
                                dbc.Label("Type de Ferlisation", className="text-center")
                            ),
                            dbc.Col(
            ...
            html.Div([
              html.Div([ # SCENARIO TABLE
                ...
                columns=([
                  ...
                  #   {"id": "fert-day1", "name": "FDOY(1)"},
                    {"id": "N_1_Kg", "name": "N(Kg/ha)(1)"},
                  #  {"id": "N_1", "name": "N(Kg/ha)(1)"},
                    {"id": "P_1_Kg", "name": "P(Kg/ha)(1)"},
                  #  {"id": "P_1", "name": "P(Kg/ha)(1)"},
                    {"id": "K_1_Kg", "name": "K(Kg/ha)(1)"},
                  #   {"id": "K_1", "name": "K(Kg/ha)(1)"},
                    {"id": "Fert_2_DOY", "name": "FDOY(2)"},
                  #  {"id": "fert-day2", "name": "FDOY(2)"},
                    {"id": "N_2_Kg", "name": "N(Kg/ha)(2)"},
                  #   {"id": "N_2", "name": "N(Kg/ha)(1)"},
                    {"id": "P_2_Kg", "name": "P(Kg/ha)(2)"},
                  #  {"id": "P_2", "name": "P(Kg/ha)(1)"},
                    {"id": "K_2_Kg", "name": "K(Kg/ha)(2)"},
                  #  {"id": "K_2", "name": "K(Kg/ha)(1)"},
                ...
                #    dict(**{param: "N/A" for param in sce_col_names}) for i in range(1, 2)
                 #   {param: "N/A" for param in sce_col_names}
                #],
                style_table = {
                    "overflowX": "auto",
                    "minWidth": "100%",
...
##  dcc.Graph(figure=html.Iframe(srcDoc=a.get_root().render(), width="30%", height="30")), #   # Affichage de la cate
        ...
        html.Div([
            dbc.Label(" on va mettre la carte ici"),
...
@app.callback(
        Output("Form_ang2","options"),
        Input("typ_fert2","value")
)
def set_type_ang2(ang2_choisi):
    return [{"label": i,"value":i} for i in type_angrais[ang2_choisi]]

@app.callback(
        Output("Form_ang2","value"),
        Input("Form_ang2", "options")
)
def set_Form_ang2(option2_valide):
    return option2_valide[0]["value"]

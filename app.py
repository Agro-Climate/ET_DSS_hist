...
app.layout = html.Div(
    [
        ...
        html.Div(
            dbc.Row(dbc.Col(html.Img(src=app.get_asset_url("ethioagroclimate.png"), className='mx-auto d-block')), 
                ...
                html.Div(
                  dbc.Row([ ## MAIN PART
                    ...
                    dbc.Col([ ## RIGHT HAND SIDE -- CARDS WITH SIMULATION ETC
                                  ...
                                  html.Div([
                                    ...
                                    html.Div([
                                        html.Button(id='EB-button-state', children='Display figures for Enterprise Budgets',
                                          # style={"width": "100%",'background-color': '#f44336'}
                                        ), #red
                                    ],),
                                    html.Br(),
                      ...
                      className='block', ), # style={'padding': '0px', 'margin': '0px', 'width': '100%'}

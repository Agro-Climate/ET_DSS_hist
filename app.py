...
app.layout = html.Div(
    [
        ...
        html.Div([
            html.Br(),
            html.Span("1) Select a station name for analysis", className="uppercase bold", style={'textAlign': 'Center'}),
            html.Br(),
        ...
        html.Div([
            html.Span("2) Period considered for the simulation", className="uppercase bold", style={'textAlign': 'Center'}),
            html.Br(),
            html.Span(" (first and last year [YYYY])", style={'textAlign': 'Center'}),
        ...
        html.Div([
            ...
            html.Br(),
            html.Span("5) Select Soil type to simulate", className="uppercase bold", style={'textAlign': 'Center'}),
            html.Div(["Soil: ",
                    dcc.Dropdown(id='ETsoil', options=[{'label': 'ETET000010(AWAS,L)', 'value': 'ETET000010'},
                                ...
                                value='ETET001_18')]),
            html.Br(),
            html.Span("6) Select initial soil water condition", className="uppercase bold", style={'textAlign': 'Center'}),
            html.Br(),
            html.Span("7) Select initial NO3 condition", className="uppercase bold", style={'textAlign': 'Center'}),
            html.Br(),
            html.Span("8) Select Planting Density", className="uppercase bold", style={'textAlign': 'Center'}),
            html.Br(),
